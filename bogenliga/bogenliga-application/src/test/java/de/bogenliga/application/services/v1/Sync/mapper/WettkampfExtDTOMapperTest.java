...
public class WettkampfExtDTOMapperTest {
    ...
    @Test
    public void toDTO() {
        WettkampfDO wettkampfDO = getDO();
        final WettkampfExtDTO actual = WettkampfExtDTOMapper.toDTO.apply(wettkampfDO);
        assertThat(actual.getId()).isEqualTo(ID);
        assertThat(actual.getOfflineToken()).isEqualTo(OFFLINETOKEN);
        assertThat(actual).isEqualToComparingFieldByField(getExtDTO());
    }
}