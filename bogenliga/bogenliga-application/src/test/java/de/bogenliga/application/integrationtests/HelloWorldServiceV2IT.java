package de.bogenliga.application.integrationtests;
...
import de.bogenliga.application.services.v2.hello.Greeting;
...
public class HelloWorldServiceV2IT {
    ...
    private final String resourceUrl = "/v2/hello-world";
    @LocalServerPort
    private int port;
    @Autowired
    ...
    private void assertGetGreetingRequest(final String serviceUrl, final String expected) {
        final ResponseEntity<Greeting> entity = this.testRestTemplate.getForEntity(
                serviceUrl, Greeting.class);
