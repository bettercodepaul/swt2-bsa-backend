create or replace view  schuetzenstatistik
            (schuetzenstatistik_veranstaltung_id, schuetzenstatistik_veranstaltung_name,
             ...
             schuetzenstatistik_match_id, schuetzenstatistik_dsb_mitglied_id, schuetzenstatistik_dsb_mitglied_name, schuetzenstatistik_pfeilpunkte_schnitt)
as
SELECT veranstaltung.veranstaltung_id                                                         AS schuetzenstatistik_veranstaltung_id,
       ...
       dsb_mitglied.dsb_mitglied_vorname || ' ' || dsb_mitglied.dsb_mitglied_nachname                AS schuetzenstatistik_dsb_mitglied_name,
...
GROUP BY
    ...
    dsb_mitglied.dsb_mitglied_vorname || ' ' || dsb_mitglied.dsb_mitglied_nachname,
