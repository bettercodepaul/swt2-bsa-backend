CREATE OR REPLACE VIEW pfeilschnitte_schuetze_veranstaltung (
...
SELECT
    ...
    MAX(CASE WHEN sub.wettkampf_tag = 1 THEN sub.pfeilschnitt_wettkampf END)    AS pfeilschnitte_schuetze_veranstaltung_wettkampftag_1_schnitt,
    MAX(CASE WHEN sub.wettkampf_tag = 1 THEN sub.wettkampf_id END)              AS pfeilschnitte_schuetze_veranstaltung_wettkampftag_1_id,
    MAX(CASE WHEN sub.wettkampf_tag = 2 THEN sub.pfeilschnitt_wettkampf END)    AS pfeilschnitte_schuetze_veranstaltung_wettkampftag_2_schnitt,
    MAX(CASE WHEN sub.wettkampf_tag = 2 THEN sub.wettkampf_id END)              AS pfeilschnitte_schuetze_veranstaltung_wettkampftag_2_id,
    MAX(CASE WHEN sub.wettkampf_tag = 3 THEN sub.pfeilschnitt_wettkampf END)    AS pfeilschnitte_schuetze_veranstaltung_wettkampftag_3_schnitt,
    MAX(CASE WHEN sub.wettkampf_tag = 3 THEN sub.wettkampf_id END)              AS pfeilschnitte_schuetze_veranstaltung_wettkampftag_3_id,
    MAX(CASE WHEN sub.wettkampf_tag = 4 THEN sub.pfeilschnitt_wettkampf END)    AS pfeilschnitte_schuetze_veranstaltung_wettkampftag_4_schnitt,
    MAX(CASE WHEN sub.wettkampf_tag = 4 THEN sub.wettkampf_id END)              AS pfeilschnitte_schuetze_veranstaltung_wettkampftag_4_id,
    MAX(veranstaltung_schnitt.pfeilschnitt_veranstaltung)                                     AS pfeilschnitte_schuetze_veranstaltung_veranstaltung_schnitt,
    MAX(veranstaltung_schnitt.veranstaltung_id)                                               AS pfeilschnitte_schuetze_veranstaltung_veranstaltung_id,
    MAX(mannschaft.mannschaft_verein_id)                                           AS pfeilschnitte_schuetze_veranstaltung_verein_id,
    sub.pfeilwerte_schuetze_match_dsb_mitglied_id                           AS pfeilschnitte_schuetze_veranstaltung_dsb_mitglied_id,
    MAX(sub.match_mannschaft_id)                                            AS pfeilschnitte_schuetze_veranstaltung_mannschaft_id
...
FROM (
    ...
    GROUP BY
        w.wettkampf_veranstaltung_id, pfeilwerte_schuetze_match_dsb_mitglied_id
         ...
         AND  pfeilwerte_schuetze_match_dsb_mitglied_id = veranstaltung_schnitt.dsb_mitglied_id
