IF NOT EXISTS (SELECT 1 FROM benutzer WHERE benutzer_id = 10)
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM benutzer WHERE benutzer_id = 11)
BEGIN
    INSERT INTO benutzer (
        benutzer_id,
        benutzer_email,
...
IF NOT EXISTS (SELECT 1 FROM benutzer WHERE benutzer_id = 12)
BEGIN
    INSERT INTO benutzer (
        benutzer_id,
        benutzer_email,
...
IF NOT EXISTS (SELECT 1 FROM benutzer_rolle WHERE benutzer_rolle_benutzer_id = 10 AND benutzer_rolle_rolle_id = 2)
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM benutzer_rolle WHERE benutzer_rolle_benutzer_id = 11 AND benutzer_rolle_rolle_id = 4)
BEGIN
    INSERT INTO benutzer_rolle (
        benutzer_rolle_benutzer_id,
        benutzer_rolle_rolle_id
...
IF NOT EXISTS (SELECT 1 FROM benutzer_rolle WHERE benutzer_rolle_benutzer_id = 12 AND benutzer_rolle_rolle_id = 5)
BEGIN
    INSERT INTO benutzer_rolle (
        benutzer_rolle_benutzer_id,
        benutzer_rolle_rolle_id
...
IF NOT EXISTS (SELECT 1 FROM benutzer WHERE benutzer_id = 13)
BEGIN
    INSERT INTO benutzer (
        benutzer_id,
        benutzer_email,
...
IF NOT EXISTS (SELECT 1 FROM benutzer_rolle WHERE benutzer_rolle_benutzer_id = 13 AND benutzer_rolle_rolle_id = 2)
BEGIN
    INSERT INTO benutzer_rolle (
        benutzer_rolle_benutzer_id,
        benutzer_rolle_rolle_id
