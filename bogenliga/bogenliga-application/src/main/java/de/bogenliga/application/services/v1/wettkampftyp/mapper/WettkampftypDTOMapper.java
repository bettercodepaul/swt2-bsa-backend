...
public class WettkampftypDTOMapper implements DataTransferObjectMapper {
    ...
    public static final Function<WettkampftypDO, WettkampftypDTO> toDTO = wettkampftypDO -> {
        final Long wettkampftypId = wettkampftypDO.getWettkampftypId();
        final String wettkampftypName = wettkampftypDO.getWettkampftypName();
        ...
        return new WettkampftypDTO(wettkampftypId, wettkampftypName, createdByUserId, createdAtUtc, version);
    };
    ...
    public static final Function<WettkampftypDTO, WettkampftypDO> toDO = wettkampftypDTO -> {
        ...
        final Long wettkampftypId = wettkampftypDTO.getWettkampftypId();
        final String wettkampftypName = wettkampftypDTO.getWettkamptypName();
        ...
        return new WettkampftypDO(wettkampftypId, wettkampftypName, createdAtUtc, createdByUserId, version);
    };
