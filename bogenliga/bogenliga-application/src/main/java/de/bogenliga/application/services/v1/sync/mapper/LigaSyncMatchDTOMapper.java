...
public class LigaSyncMatchDTOMapper implements DataTransferObjectMapper {
    ...
    public static LigaSyncMatchDTO apply(MatchDO matchDO) {
        ...
        final Integer matchScheibennummer = matchDO.getMatchScheibennummer()!=null ? Math.toIntExact(matchDO.getMatchScheibennummer()) : null;
    ...
    public static LigaSyncMatchDTO apply(LigamatchDO ligamatchDO) {
        ...
        final Long srcScheibenNr = ligamatchDO.getMatchScheibennummer();
        final Integer matchScheibennummer = srcScheibenNr != null ?  Math.toIntExact(srcScheibenNr) : null;
