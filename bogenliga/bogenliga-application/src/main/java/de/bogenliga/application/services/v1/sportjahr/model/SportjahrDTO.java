 ...
 * <p>
 * *I define the payload for the external REST interface of the sportjahr business entity.
 *
...
public class SportjahrDTO implements DataTransferObject {
    ...
    public SportjahrDTO(Long sportjahrId, String name, Long createdByUserId, OffsetDateTime createdAtUtc,
                        Long version) {
        this.setId(sportjahrId);
        this.setName(name);
