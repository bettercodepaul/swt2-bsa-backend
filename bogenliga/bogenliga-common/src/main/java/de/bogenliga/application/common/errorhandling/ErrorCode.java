...
public enum ErrorCode {
    ...
    VERANSTALTUNG_MAX_CAPACITY_ERROR(ErrorCategory.BUSINESS, "VERANSTALTUNG_MAX_CAPACITY_ERROR"),
    // database
    ...
    INVALID_OFFLINE_TOKEN(ErrorCategory.BUSINESS, "INVALID_OFFLINE_TOKEN"),
    // liga specific
    LIGA_NOT_FOUND_ERROR(ErrorCategory.BUSINESS, "LIGA_NOT_FOUND_ERROR"),
    // user management
    ...
    INCORRECT_AMOUNT_OF_TEAMS(ErrorCategory.BUSINESS, "INCORRECT_AMOUNT_OF_TEAMS"),
    MANNSCHAFT_DELETE_AFTER_MELDEDEADLINE(ErrorCategory.BUSINESS, "MANNSCHAFT_DELETE_AFTER_MELDEDEADLINE"),
    PDF_DOWNLOAD_BEFORE_MELDEDEADLINE(ErrorCategory.BUSINESS, "PDF_DOWNLOAD_BEFORE_MELDEDEADLINE"),
