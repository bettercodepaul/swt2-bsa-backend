...
public enum ErrorCode {
    ...
    // thrown when a member doesn't meet the requirements to shoot in a certain season
    PARTICIPATION_CONDITION_VIOLATION(ErrorCategory.BUSINESS, "PARTICIPATION_CONDITION_VIOLATION"),
