...
CREATE TABLE veranstaltung (
  ...
  veranstaltung_wettkampfdauer      FLOAT (2,1), -- Dauer eines Wettkampf, i.d.R. 0,5
...
-- TODO Referenz zum User statt "ligaleiter-texte"
  ...
  CONSTRAINT fk_veranstaltung_veranstaltung FOREIGN KEY (veranstaltung_veranstaltung_id) REFERENCES veranstaltung (veranstaltung_id)
