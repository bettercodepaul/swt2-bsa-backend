...
ALTER TABLE passe
  ADD COLUMN passe_mannschaft_id      DECIMAL(19,0)  NULL, --Fremdschlüsselbezug zum Mannschaft

  ADD CONSTRAINT fk_passe_mannschaft FOREIGN KEY (passe_mannschaft_id) REFERENCES mannschaft (mannschaft_id)
