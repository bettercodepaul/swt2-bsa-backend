...
VALUES
  (1, 30, 1, 28, 9,9,NULL,NULL,NULL,NULL),
  (1, 30, 1, 31, 10,10,NULL,NULL,NULL,NULL),
  (1, 30, 1, 47, 10,8,NULL,NULL,NULL,NULL),
  (2, 30, 1, 28, 9,6,NULL,NULL,NULL,NULL),
  (2, 30, 1, 31, 10,10,NULL,NULL,NULL,NULL),
  (2, 30, 1, 47, 10,8,NULL,NULL,NULL,NULL),
  (3, 30, 1, 28, 9,6,NULL,NULL,NULL,NULL),
  (3, 30, 1, 31, 10,8,NULL,NULL,NULL,NULL),
  (3, 30, 1, 47, 10,8,NULL,NULL,NULL,NULL),
  (4, 30, 1, 28, 9,9,NULL,NULL,NULL,NULL),
  (4, 30, 1, 31, 10,10,NULL,NULL,NULL,NULL),
  (4, 30, 1, 47, 10,8,NULL,NULL,NULL,NULL),

  (1, 30, 1, 441, 8,7,NULL,NULL,NULL,NULL),
  (1, 30, 1, 393, 10,10,NULL,NULL,NULL,NULL),
  (1, 30, 1, 385, 8,7,NULL,NULL,NULL,NULL),
  (2, 30, 1, 441, 10,7,NULL,NULL,NULL,NULL),
  (2, 30, 1, 393, 10,8,NULL,NULL,NULL,NULL),
  (2, 30, 1, 385, 8,7,NULL,NULL,NULL,NULL),
  (3, 30, 1, 441, 10,7,NULL,NULL,NULL,NULL),
  (3, 30, 1, 393, 10,8,NULL,NULL,NULL,NULL),
  (3, 30, 1, 385, 9,9,NULL,NULL,NULL,NULL),
  (4, 30, 1, 441, 10,7,NULL,NULL,NULL,NULL),
  (4, 30, 1, 393, 10,8,NULL,NULL,NULL,NULL),
  (4, 30, 1, 385, 10,8,NULL,NULL,NULL,NULL),

  (1, 30, 1, 71, 8,7,NULL,NULL,NULL,NULL),
  (1, 30, 1, 80, 10,10,NULL,NULL,NULL,NULL),
  (1, 30, 1, 103, 8,7,NULL,NULL,NULL,NULL),
  (2, 30, 1, 71, 10,7,NULL,NULL,NULL,NULL),
  (2, 30, 1, 80, 10,7,NULL,NULL,NULL,NULL),
  (2, 30, 1, 103, 10,10,NULL,NULL,NULL,NULL),
  (3, 30, 1, 71, 7,7,NULL,NULL,NULL,NULL),
  (3, 30, 1, 80, 10,8,NULL,NULL,NULL,NULL),
  (3, 30, 1, 103, 9,6,NULL,NULL,NULL,NULL),
  (4, 30, 1, 71, 10,10,NULL,NULL,NULL,NULL),
  (4, 30, 1, 80, 10,8,NULL,NULL,NULL,NULL),
  (4, 30, 1, 103, 10,10,NULL,NULL,NULL,NULL),
  (5, 30, 1, 71, 10,7,NULL,NULL,NULL,NULL),
  (5, 30, 1, 80, 10,8,NULL,NULL,NULL,NULL),
  (5, 30, 1, 103, 10,7,NULL,NULL,NULL,NULL),

  (1, 30, 1, 193, 8,7,NULL,NULL,NULL,NULL),
  (1, 30, 1, 189, 10,10,NULL,NULL,NULL,NULL),
  (1, 30, 1, 249, 8,7,NULL,NULL,NULL,NULL),
  (2, 30, 1, 193, 8,7,NULL,NULL,NULL,NULL),
  (2, 30, 1, 189, 7,6,NULL,NULL,NULL,NULL),
  (2, 30, 1, 249, 8,7,NULL,NULL,NULL,NULL),
  (3, 30, 1, 193, 10,7,NULL,NULL,NULL,NULL),
  (3, 30, 1, 189, 9,6,NULL,NULL,NULL,NULL),
  (3, 30, 1, 249, 10,7,NULL,NULL,NULL,NULL),
  (4, 30, 1, 193, 10,7,NULL,NULL,NULL,NULL),
  (4, 30, 1, 189, 7,6,NULL,NULL,NULL,NULL),
  (4, 30, 1, 249, 8,7,NULL,NULL,NULL,NULL),
  (5, 30, 1, 193, 10,7,NULL,NULL,NULL,NULL),
  (5, 30, 1, 189, 10,6,NULL,NULL,NULL,NULL),
  (5, 30, 1, 249, 8,7,NULL,NULL,NULL,NULL),

  (1, 30, 1, 45, 10,10,NULL,NULL,NULL,NULL),
  (1, 30, 1, 72, 10,10,NULL,NULL,NULL,NULL),
  (1, 30, 1, 104, 10,9,NULL,NULL,NULL,NULL),
  (2, 30, 1, 45, 7,6,NULL,NULL,NULL,NULL),
  (2, 30, 1, 72, 10,10,NULL,NULL,NULL,NULL),
  (2, 30, 1, 104, 9,9,NULL,NULL,NULL,NULL),
  (3, 30, 1, 45, 10,9,NULL,NULL,NULL,NULL),
  (3, 30, 1, 72, 9,9,NULL,NULL,NULL,NULL),
  (3, 30, 1, 104, 10,9,NULL,NULL,NULL,NULL),
  (4, 30, 1, 45, 10,9,NULL,NULL,NULL,NULL),
  (4, 30, 1, 72, 10,9,NULL,NULL,NULL,NULL),
  (4, 30, 1, 104, 9,7,NULL,NULL,NULL,NULL),

  (1, 30, 1, 44, 10,8,NULL,NULL,NULL,NULL),
  (1, 30, 1, 78, 10,7,NULL,NULL,NULL,NULL),
  (1, 30, 1, 110, 10,8,NULL,NULL,NULL,NULL),
  (2, 30, 1, 44, 10,8,NULL,NULL,NULL,NULL),
  (2, 30, 1, 78, 10,7,NULL,NULL,NULL,NULL),
  (2, 30, 1, 110, 9,9,NULL,NULL,NULL,NULL),
  (3, 30, 1, 44, 10,9,NULL,NULL,NULL,NULL),
  (3, 30, 1, 78, 9,6,NULL,NULL,NULL,NULL),
  (3, 30, 1, 110, 10,6,NULL,NULL,NULL,NULL),
  (4, 30, 1, 44, 10,9,NULL,NULL,NULL,NULL),
  (4, 30, 1, 78, 10,6,NULL,NULL,NULL,NULL),
  (4, 30, 1, 110, 9,7,NULL,NULL,NULL,NULL),

  (1, 30, 1, 190, 10,8,NULL,NULL,NULL,NULL),
  (1, 30, 1, 216, 10,10,NULL,NULL,NULL,NULL),
  (1, 30, 1, 240, 10,8,NULL,NULL,NULL,NULL),
  (2, 30, 1, 190, 8,8,NULL,NULL,NULL,NULL),
  (2, 30, 1, 216, 8,7,NULL,NULL,NULL,NULL),
  (2, 30, 1, 240, 6,6,NULL,NULL,NULL,NULL),
  (3, 30, 1, 190, 10,9,NULL,NULL,NULL,NULL),
  (3, 30, 1, 216, 9,7,NULL,NULL,NULL,NULL),
  (3, 30, 1, 240, 10,6,NULL,NULL,NULL,NULL),
  (4, 30, 1, 190, 10,9,NULL,NULL,NULL,NULL),
  (4, 30, 1, 216, 10,9,NULL,NULL,NULL,NULL),
  (4, 30, 1, 240, 10,9,NULL,NULL,NULL,NULL),

  (1, 30, 1, 180, 10,8,NULL,NULL,NULL,NULL),
  (1, 30, 1, 220, 10,6,NULL,NULL,NULL,NULL),
  (1, 30, 1, 127, 10,7,NULL,NULL,NULL,NULL),
  (2, 30, 1, 180, 10,9,NULL,NULL,NULL,NULL),
  (2, 30, 1, 220, 7,6,NULL,NULL,NULL,NULL),
  (2, 30, 1, 127, 6,0,NULL,NULL,NULL,NULL),
  (3, 30, 1, 180, 10,9,NULL,NULL,NULL,NULL),
  (3, 30, 1, 220, 9,7,NULL,NULL,NULL,NULL),
  (3, 30, 1, 127, 10,6,NULL,NULL,NULL,NULL),
  (4, 30, 1, 180, 10,8,NULL,NULL,NULL,NULL),
  (4, 30, 1, 220, 10,8,NULL,NULL,NULL,NULL),
  (4, 30, 1, 127, 10,9,NULL,NULL,NULL,NULL)
;
