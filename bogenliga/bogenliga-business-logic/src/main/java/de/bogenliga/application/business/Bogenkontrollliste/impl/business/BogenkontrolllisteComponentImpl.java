 ...
 */
@Component
public class BogenkontrolllisteComponentImpl implements SchusszettelComponent {
    ...
    @Autowired
    public BogenkontrolllisteComponentImpl(final MatchComponent matchComponent,
