...
public class MatchMapper implements ValueObjectMapper {
    ...
    public static final Function<MatchDO, MatchBE> toMatchBE = matchDO -> {
        ...
        matchBE.setStrafPunktSatz1(matchDO.getStrafPunkteSatz1());
        matchBE.setStrafPunktSatz2(matchDO.getStrafPunkteSatz2());
        matchBE.setStrafPunktSatz3(matchDO.getStrafPunkteSatz3());
        matchBE.setStrafPunktSatz4(matchDO.getStrafPunkteSatz4());
        matchBE.setStrafPunktSatz5(matchDO.getStrafPunkteSatz5());
