package de.bogenliga.application.business.Setzliste.business;

import de.bogenliga.application.business.Setzliste.dao.SetzlisteDAO;
 ...
 */
@Component
public class SetzlisteComponentImpl implements DsbMitgliedComponent {
     ...
     */
    @Autowired
    public SetzlisteComponentImpl(final DsbMitgliedDAO dsbMitgliedDAO) {
