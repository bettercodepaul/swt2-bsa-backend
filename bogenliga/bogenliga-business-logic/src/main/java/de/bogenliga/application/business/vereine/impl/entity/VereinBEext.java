 ...
 */
public class VereinBEext extends CommonBusinessEntity implements BusinessEntity {
    ...
    private String vereinRegionName;
    /**
     * Empty constructor
     */
    public VereinBEext() {
    ...
    public String getVereinRegionName() { return vereinRegionName; }

    public void setVereinRegionName(String vereinRegionName) { this.vereinRegionName = vereinRegionName; }
    ...
    public String toString() {
        return "VereinBE{" +
                ...
                ", vereinRegionName='" + vereinRegionName + '\'' +
                "}";
    }
}
