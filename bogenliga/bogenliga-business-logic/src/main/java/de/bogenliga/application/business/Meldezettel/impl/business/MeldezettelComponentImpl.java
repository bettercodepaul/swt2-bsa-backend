...
public class MeldezettelComponentImpl implements MeldezettelComponent {
    ...
    private void generateDoc(Document doc, Long wettkampfTag, String veranstaltungsName, String disziplinsName, Date wettkampfDatum, Hashtable<String, List<DsbMitgliedDO>> teamMemberMapping) {
        ...
        for (int manschaftCounter = 0; manschaftCounter < 8; manschaftCounter++) {
            ...
            mainTable
                .addCell(new Cell().setBorder(Border.NO_BORDER)
                        .add(mainTableFirstRowFirstPart).setPaddingRight(20.0F).setPaddingBottom(10.0F)
                )
                .addCell(new Cell().setBorder(Border.NO_BORDER)
                        .add(mainTableFirstRowSecondPart).setPaddingLeft(20.0F).setPaddingBottom(10.0F)
                )
                .addCell(new Cell().setBorder(Border.NO_BORDER)
                        .add(mainTableSecondRowFirstPart).setPaddingRight(20.0F).setPaddingBottom(10.0F)
                )
                .addCell(new Cell().setBorder(Border.NO_BORDER)
                        .add(mainTableSecondRowSecondPart).setPaddingLeft(20.0F).setPaddingBottom(10.0F)
                )
                .addCell(new Cell().setBorder(Border.NO_BORDER)
                        .add(mainTableThirdRowFirstPart).setPaddingRight(20.0F).setPaddingBottom(10.0F)
                )
                .addCell(new Cell().setBorder(Border.NO_BORDER)
                        .add(mainTableThirdRowSecondPart).setPaddingLeft(20.0F).setPaddingBottom(10.0F)
                )
                .addCell(new Cell().setBorder(Border.NO_BORDER)
                        .add(mainTableFourthRowFirstPart).setPaddingRight(20.0F).setPaddingBottom(10.0F)
                )
                .addCell(new Cell().setBorder(Border.NO_BORDER)
                        .add(mainTableFourthRowSecondPart).setPaddingLeft(20.0F).setPaddingBottom(10.0F)
                )
                .addCell(new Cell().setBorder(Border.NO_BORDER)
                        .add(mainTableFifthRowFirstPart).setPaddingRight(20.0F)
                )
                .addCell(new Cell().setBorder(Border.NO_BORDER)
                        .add(mainTableFifthRowSecondPart).setPaddingLeft(20.0F)
                )
            ;
