package de.bogenliga.application.business.kampfrichterlizenz.impl.dao;
 ...
 */
@Repository
public class KampfrichterlizenzDAO implements DataAccessObject {

    // define the logger context
    private static final Logger LOGGER = LoggerFactory.getLogger(KampfrichterlizenzDAO.class);
    ...
    private static final BusinessEntityConfiguration<KampfrichterlizenzBE> DSBMITGLIED = new BusinessEntityConfiguration<>(
            KampfrichterlizenzBE.class, TABLE, getColumnsToFieldsMap(), LOGGER);
     ...
     */
    @Autowired
    public KampfrichterlizenzDAO(final BasicDAO basicDao) {
     ...
     */
    public List<KampfrichterlizenzBE> findAll() {
     ...
     * @param id
     */
    public KampfrichterlizenzBE findById(final long id) {
     ...
     */
    public KampfrichterlizenzBE create(final KampfrichterlizenzBE dsbMitgliedBE, final long currentDsbMitgliedId) {
     ...
     */
    public KampfrichterlizenzBE update(final KampfrichterlizenzBE dsbMitgliedBE, final long currentDsbMitgliedId) {
     ...
     * @param currentDsbMitgliedId
     */
    public void delete(final KampfrichterlizenzBE dsbMitgliedBE, final long currentDsbMitgliedId) {
        basicDao.setModificationAttributes(dsbMitgliedBE, currentDsbMitgliedId);
