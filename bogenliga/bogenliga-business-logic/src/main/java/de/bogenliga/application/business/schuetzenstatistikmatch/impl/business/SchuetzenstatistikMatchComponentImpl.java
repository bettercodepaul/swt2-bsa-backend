...
public class SchuetzenstatistikMatchComponentImpl implements SchuetzenstatistikMatchComponent {
    ...
    private static final String PRECONDITION_TAG = "tag cannot be null or negative";
    ...
    @Override
    public List<SchuetzenstatistikMatchDO> getSchuetzenstatistikMatchWettkampf(Long wettkampfId, Long vereinId, Long tag) {
        Preconditions.checkArgument(wettkampfId >= 0, PRECONDITION_WETTKAMPFID);
        Preconditions.checkArgument(vereinId >= 0, PRECONDITION_VEREINID);
        Preconditions.checkArgument(tag >= 0, PRECONDITION_TAG);

        final ArrayList<SchuetzenstatistikMatchDO> returnList = new ArrayList<>();
        final List<SchuetzenstatistikMatchBE> schuetzenstatistikMatchBEList = schuetzenstatistikMatchDAO.getSchuetzenstatistikMatchWettkampf(wettkampfId, vereinId, tag);
        if (schuetzenstatistikMatchBEList == null) {
