...
public class UserLoginHistoryDAO implements DataAccessObject {
    ...
    public UserFailedLoginAttemptsBE findSignInUserInformationByEmail(final long userId,
                                                                      final long timeRangeInSeconds) {
        return basicDao.selectSingleEntity(USER_SIGN_IN, FIND_SIGNIN_INFO_BY_ID,
